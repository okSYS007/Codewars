...
# and an optional margin. The function should return whether a is lower than, close to, or higher than b.

# Please note the following:

# When a is close to b, return 0.
# For this challenge, a is considered "close to" b if margin 
# is greater than or equal to the absolute distance between a and b.
# Otherwise...
